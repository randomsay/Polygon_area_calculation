...
class UnitTests(unittest.TestCase):
    def setUp(self):
        self.rect = polygon_area_calculate.Rectangle(3, 6)
        self.sq = polygon_area_calculate.Square(5)

    def test_subclass(self):
        actual = issubclass(polygon_area_calculate.Square, polygon_area_calculate.Rectangle)
        expected = True
        self.assertEqual(actual, expected, 'Expected Square class to be a subclass of the Rectangle class.')

    def test_distinct_classes(self):
        actual = polygon_area_calculate.Square is not polygon_area_calculate.Rectangle
        expected = True
    ...
    def test_square_is_square_and_rectangle(self):
        actual = isinstance(self.sq, polygon_area_calculate.Square) and isinstance(self.sq, polygon_area_calculate.Rectangle)
        expected = True
    ...
    def test_get_amount_inside_two_rectangles(self):
        rect2 = polygon_area_calculate.Rectangle(4, 8)
    ...
    def test_get_amount_inside_none(self):
        rect2 = polygon_area_calculate.Rectangle(2, 3)
        actual = rect2.get_amount_inside(self.rect)
        expected = 0
